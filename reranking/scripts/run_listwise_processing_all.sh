...
PYTHON_SCRIPT="${SCRIPT_DIR}/../processing_listwise.py"
DATASETS=("ciral" "clef")
  ...
  for ranking_base in "${retriever_dirs[@]}"; do
    ...
    for trec_file in "${trec_files[@]}"; do
        ...
        for i in "${!DOC_DIRS[@]}"; do
          ...
          output_dir="${RERANKING_BASE}/processed_listwise/${dataset}/${retriever}_${suffix}"

          echo "Running listwise processing for: $dataset : $retriever : $prefix [${suffix}]"
